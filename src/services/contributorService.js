...
export const contributorService = {
  ...
  // params: { page, limit, search } — omit limit for the full list
  getMembers:   (params)     => api.get('/contributors/members', { params }),
  deleteAllMembers: ()       => api.delete('/contributors/members'),
