          ...
          {contributions.map(c => {
            ...
            return (
              <tr key={c.id}>
                ...
                <td className="td-money td-paid" data-label="Paid">{formatCurrency(c.paid_amount)}</td>
                <td className="td-money td-outstanding" data-label="Outstanding">{formatCurrency(outstanding)}</td>
